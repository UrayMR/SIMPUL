        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                ...
                <p class="fs-5 opacity-75 mb-0">
                    Mulai dari penguatan akademik, keterampilan praktis, <br>hingga pengembangan kompetensi profesional semua tersedia dalam satu platform.
                </p>
                        ...
                        @forelse ($courses as $course)
                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <x-card title="{{ $course->title }}" category="{{ $course->category->name }}"
                                    price="{{ $course->price }}" teacher="{{ $course->teacher->user->name }}" id="{{ $course->id }}"/>
                            </div>
                        @empty
                            <div class="col-12">
