                ...
                <aside class="col-lg-3 mb-4">
                    <div class="bg-white rounded-4 shadow-sm p-4">
                        ...
                        <form method="GET">
                            ...
                            {{-- SORT PRICE --}}
                            <h6 class="fw-bold mt-4 mb-3">Urutkan Harga</h6>

                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sort_price" id="sort-default"
                                    value="" {{ request('sort_price') === null ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sort_price" id="sort-low"
                                    value="asc" {{ request('sort_price') === 'asc' ? 'checked' : '' }}>
                                <label class="form-check-label" for="sort-low">
                                    Termurah - Termahal
                                </label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sort_price" id="sort-high"
                                    value="desc" {{ request('sort_price') === 'desc' ? 'checked' : '' }}>
                                <label class="form-check-label" for="sort-high">
                                    Termahal - Termurah
                                </label>
                            </div>
                            ...
                            @auth
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ownership" value=""
                                        id="all" {{ request('ownership') === null ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ownership" value="true"
                                        id="owned" {{ request('ownership') === 'true' ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="ownership" value="false"
                                        id="not-owned" {{ request('ownership') === 'false' ? 'checked' : '' }}>
                            ...
                            <div class="d-flex gap-2 pt-3 border-top">
                                ...
                                <a href="{{ route('course.index') }}"
                                    ...
                                    style="width: 34px; height: 34spx;" aria-label="Reset filter">
