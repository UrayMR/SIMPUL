				...
				<aside class="col-lg-3 mb-4">
					<div class="bg-white rounded-4 shadow-sm p-4">
						...
						<form method="GET">
							...
							<div class="form-check mb-2">
								<input class="form-check-input" type="radio" name="ownership" id="owned" value="true"
									{{ request('ownership') === true ? 'checked' : '' }}>
							...
							<div class="form-check mb-2">
								<input class="form-check-input" type="radio" name="ownership" id="not_owned" value="false"
									{{ request('ownership') === false ? 'checked' : '' }}>
						...
						@forelse ($courses as $course)
							<div class="col-12 col-md-6 col-lg-4 mb-4">
								<x-card title="{{ $course->title }}" category="{{ $course->category->name }}" price="{{ $course->price }}"
									teacher="{{ $course->teacher->user->name }}" id="{{ $course->id }}" />
							</div>
						@empty
							<div class="col-12">
