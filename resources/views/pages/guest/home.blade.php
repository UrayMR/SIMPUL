	...
	<main>
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-5 mb-4 mb-lg-0" data-aos="fade-right">
						...
						<div class="profil-image">
							<img src="{{ asset('assets/img/background/1.png') }}" alt="Profil" class="img-fluid rounded-4">
						</div>
					</div>
					...
					<div class="col-lg-7 profil-content ps-lg-5" data-aos="fade-left">
						...
						<a href="{{ route('kategori.index') }}" class="btn btn-light text-app-primary fw-semibold">
		...
		<section class="pelayanan-section bg-white" data-aos="fade-up">
			<div class="container py-5 ">
				...
				<div class="d-flex justify-content-center justify-content-lg-end mb-3" data-aos="fade-left" data-aos-delay="200">
				...
				<div class="row">
					@foreach ($courses as $index => $course)
						<div class="col-12 col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="{{ 100 + $index * 100 }}">
							<x-card title="{{ $course->title }}" category="{{ $course->category->name }}" price="{{ $course->price }}"
								teacher="{{ $course->teacher->user->name }}" id="{{ $course->id }}" image="{{ $course->thumbnail_path }}"
								count="{{ $course->enrollments_count }}" owned="{{ $course->isOwnedBy(auth()->user()) }}" />
						</div>
					@endforeach
			...
			<div class="container ">
				<div class="row align-items-center bg-app-primary rounded p-4 p-lg-5" style="overflow:hidden;">
					...
					<div class="col-lg-7 profil-content" data-aos="fade-right">
						...
						<a href="{{ route('lowongan-karir.index') }}" class="btn btn-light text-app-primary fw-semibold">
					...
					<div class="col-lg-5 text-center" data-aos="fade-left">
						...
						<div class="profil-image">
							<img src="{{ asset('assets/img/background/2.png') }}" alt="Profil" class="img-fluid rounded-4">
						</div>
					</div>
